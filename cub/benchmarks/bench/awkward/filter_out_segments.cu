...
#include "filter_out_segments_fancy_iterator_direct_offsets_zipped.cuh"
...
// Step 4: Implementation using segment ids, run-length encoding, and a scan + zip 3 input arrays
template <typename T>
static void filter_out_segments_rle_scan_zipped(nvbench::state& state, nvbench::type_list<T>)
{
#if RUN_SAMPLE
  // Example: [[30], [40,20], [50], [10,30,80]]
...
// Step 5: Implement using segment ids and cub::DeviceSelect::If + zip 3 input arrays
template <typename T>
static void filter_out_segments_copy_if_zipped(nvbench::state& state, nvbench::type_list<T>)
{
#if RUN_SAMPLE
  // Example: [[30], [40,20], [50], [10,30,80]]
  //          [[2.1], [2.2,-1.5], [3], [0.4,3.7,-1.2]]
...
// Step 6: Implement using fancy iterator to get segment ids on-the-fly + zip 3 input arrays
template <typename T>
static void filter_out_segments_fancy_iterator_zipped(nvbench::state& state, nvbench::type_list<T>)
{
#if RUN_SAMPLE
  // Example: [[30], [40,20], [50], [10,30,80]]
  //          [[2.1], [2.2,-1.5], [3], [0.4,3.7,-1.2]]
...
// Step 7: Implement using fancy iterator for segment ids and direct offset reconstruction from mask + offsets
template <typename T>
static void filter_out_segments_fancy_iterator_direct_offsets_zipped(nvbench::state& state, nvbench::type_list<T>)
{
#if RUN_SAMPLE
  // Example: [[30], [40,20], [50], [10,30,80]]
  //          [[2.1], [2.2,-1.5], [3], [0.4,3.7,-1.2]]
  ...
  auto [d_selected_pt, d_selected_eta, d_selected_phi, d_new_offsets] =
    filter_out_segments_fancy_iterator_direct_offsets_zipped(d_pt, d_eta, d_phi, d_offsets, d_mask);
...
NVBENCH_BENCH_TYPES(filter_out_segments_rle_scan_zipped, NVBENCH_TYPE_AXES(current_data_types))
  .set_name("filter_out_segments_rle_scan_zipped")
  .set_type_axes_names({"T{ct}"})
  .add_int64_power_of_two_axis("Elements{io}", nvbench::range(12, 24, 4))
  .add_string_axis("Entropy", {"1.000", "0.544", "0.000"});

NVBENCH_BENCH_TYPES(filter_out_segments_copy_if_zipped, NVBENCH_TYPE_AXES(current_data_types))
  .set_name("filter_out_segments_copy_if_zipped")
  .set_type_axes_names({"T{ct}"})
  .add_int64_power_of_two_axis("Elements{io}", nvbench::range(12, 24, 4))
  .add_string_axis("Entropy", {"1.000", "0.544", "0.000"});

NVBENCH_BENCH_TYPES(filter_out_segments_fancy_iterator_zipped, NVBENCH_TYPE_AXES(current_data_types))
  .set_name("filter_out_segments_fancy_iterator_zipped")
  .set_type_axes_names({"T{ct}"})
  .add_int64_power_of_two_axis("Elements{io}", nvbench::range(12, 24, 4))
  .add_string_axis("Entropy", {"1.000", "0.544", "0.000"});

NVBENCH_BENCH_TYPES(filter_out_segments_fancy_iterator_direct_offsets_zipped, NVBENCH_TYPE_AXES(current_data_types))
  .set_name("filter_out_segments_fancy_iterator_direct_offsets_zipped")
  .set_type_axes_names({"T{ct}"})
  .add_int64_power_of_two_axis("Elements{io}", nvbench::range(12, 24, 4))
  .add_string_axis("Entropy", {"1.000", "0.544", "0.000"});
