...
def unique_by_key_low_overhead(state: nvbench.State):
    "Benchmark unique_by_key_low_overhead example"
    ...
    alg = algorithms.unique_by_key_low_overhead(
...
if __name__ == "__main__":
    b = nvbench.register(unique_by_key_low_overhead)
