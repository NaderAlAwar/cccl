...
class _MergeSortLowOverhead:
    ...
    def __call__(
        ...
        temp_storage_ptr,
        temp_storage_bytes,
        d_in_keys_ptr: DeviceArrayLike | IteratorBase,
        d_in_items_ptr: DeviceArrayLike | IteratorBase | None,
        d_out_keys_ptr: DeviceArrayLike,
        d_out_items_ptr: DeviceArrayLike | None,
        num_items: int,
        stream=None,
    ):
        present_in_values = d_in_items_ptr is not None
        present_out_values = d_out_items_ptr is not None
        assert present_in_values == present_out_values
...
def merge_sort_low_overhead(
    ...
    """
    return _MergeSortLowOverhead(d_in_keys, d_in_items, d_out_keys, d_out_items, op)
